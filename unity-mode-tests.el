...
(ert-deftest unity-get-primative-test ()
  (should
   (equal
    '('test1 t 0 '("Test" "test_") '("")
            '("c" "C") '("Test/" "test/") )
    (unity-get-primative unity-temp-sensor-primatives-list 0)))
  (should
   (equal
    '('c-src t 2 '("") '("")
             '("c" "C")    '("lib/" "src/"))
    (unity-get-primative unity-temp-sensor-primatives-list 2)))
  (should-error (unity-get-primative
                 unity-temp-sensor-primatives-list -1))
  (should-not  (unity-get-primative
                unity-temp-sensor-primatives-list 100))
  ) 
 
(ert-deftest unity-get-primative-element-test ()
  (should (equal t
                 (unity-get-primative-element 'switch?
          '('test t 0 '("Test test_") '("_test" "_spec") '("c" "C") '("Test/" "test/")))))
  (should (equal ''test
                 (unity-get-primative-element 'name
          '('test t 0 '("Test test_") '("") '("c" "C") '("Test/" "test/")))))
  (should (equal ''("suffix")
                 (unity-get-primative-element 'suffixes
          '("suffix" t 0 '("Test test_") '("suffix") '("c" "C") '("Test/" "test/")))))
  (should (equal ''("Test test_")
                 (unity-get-primative-element 'prefixes
          '("test" t 0 '("Test test_") '("_test" "_spec") '("c" "C") '("Test/" "test/")))))
  (should (equal 0
...
(ert-deftest unity-test-modulus-operator ()
  (should (equal 0 (mod 6 6)))
  (should (equal 1 (mod  7 6)))
  (should (equal 2 (mod  14 6)))
  )
  
;; (ert-deftest unity-get-next-primative-test ()
;;   (should (equal
;;     '('test t 0 '("Test" "test_") '("_test" "_spec") '("c" "C") '("Test/" "test/"))
;;             (unity-get-next-primative  unity-temp-sensor-primatives-list
;;                                        nil 'up)))
;;   (should (equal
...
(ert-deftest unity-requires-cycling-p-test () 
  (should (unity-requires-cycling-p
           (unity-get-primative unity-temp-sensor-primatives-list 0)))
  (should
   (unity-requires-cycling-p
    '('org t 4 '("") '("") '("org") '(c-test-dir "./" "docs/"))))
  (should-not
   (unity-requires-cycling-p
    '('org nil 4 '("") '("") '("org") '(c-test-dir "./" "docs/"))))
  )
   
(ert-deftest unity-get-primative-affixes-test ()
  (should
   (equal '("-tests" "_spec")
          (unity-get-primative-affixes
...
;; (ert-deftest unity-strip-primative-prefixes-test ()
;;   (should
;;    (equal
;;     "file.c" (unity-strip-primative-prefixes
;;               "test_file.c" unity-temp-sensor-primatives-list)))
;;   (should
;;    (equal
;;     "file.c" (unity-strip-primative-prefixes
;;               "Testfile.c" unity-temp-sensor-primatives-list)))
;;   )

;; (ert-deftest unity-strip-primative-suffixes-test ()
;;   (should
;;    (equal
;;     "file.c" (unity-strip-primative-suffixes
;;               "file_spec.c" unity-temp-sensor-primatives-list)))
;;   (should
;;    (equal
;;     "file.c" (unity-strip-primative-suffixes
;;               "file_test.c" unity-temp-sensor-primatives-list)))
;;   (should (equal
;;     "test_file.c" (unity-strip-primative-suffixes
;;               "test_file.c" unity-temp-sensor-primatives-list)))
;;   )
 
(ert-deftest unity-strip-primative-name-test ()
  (should (equal "File"
           (unity-strip-primative-name
             "TestFile-tests.c"
  ...
  (should (equal "File"
           (unity-strip-primative-name
             "TestFile"
             unity-temp-sensor-primatives-list)))
  (should-not (equal "File"
           (unity-strip-primative-name
             "testFile"
             unity-temp-sensor-primatives-list)))
  )
 
;;   (ert-deftest unity-cycle-primatives-test ()
;;    (should (equal "something"
;;             (unity-cycle-primatives
;;              unity-temp-sensor-primatives-list 'up
;;                 ))
;;              )
;; )
  
 (ert-deftest unity-find-buffer-test()
   (should (unity-find-buffer "AdcConductor" "Test" "" "c" "test/"))
   (should (unity-find-buffer "AdcConductor" "" ""  "h" "src/"))
   (should (unity-find-buffer "AdcConductor" "" ""  "c" "src/"))
   (should-not (unity-find-buffer "AdcConductor" "Test" "" "c" "src/"))
    )

 ;; (ert-deftest  unity-get-primative-idx-test ()
 ;; (should (unity-get-primative-idx "TestAdcConductor.c" unity-temp-sensor-primatives-list))
  
 ;;   )

(ert-deftest unity--match-primative-name-prefix-test ()
  (should (unity--match-primative-name-prefix
           "TestFile.c" "Test"))
  (should-not (unity--match-primative-name-prefix
           "TestFile.c" "test"))
  (should (unity--match-primative-name-prefix
           "test_File.c" "test"))
  (should-not (unity--match-primative-name-prefix
...
(ert-deftest unity--match-primative-name-suffix-test ()
  (should (unity--match-primative-name-suffix
           "file_rspec.rb" "_rspec"))
  (should (unity--match-primative-name-suffix
           "unity-tests.el" "-tests"))
  )

(ert-deftest unity--is-primative-element-match-test ()
  (should (unity--is-primative-element-match
           "Test" '("Test" "test_")))
  (should (unity--is-primative-element-match
           "test_" '("Test" "test_")))
  (should-not (unity--is-primative-element-match
           "test" '("Test" "test_")))
  (should-not (unity--is-primative-element-match
           "test" '("" "")))
  (should (unity--is-primative-element-match
...
;; (ert-deftest unity-find-primative-test ()
;; (should (unity-find-primative "TestFile.c" unity-temp-sensor-primatives-list))
;;   ) 

(ert-deftest unity-strip-primative-prefix-test ()
  (should (equal "Test" (unity-strip-primative-prefix
                         "TestFile.c"
                         unity-temp-sensor-primatives-list)))
  (should (equal "test_" (unity-strip-primative-prefix
                         "test_File.c"
                         unity-temp-sensor-primatives-list)))
  (should-not (equal "test_" (unity-strip-primative-prefix
                         "Test_File.c"
                         unity-temp-sensor-primatives-list)))
  (should (equal "" (unity-strip-primative-prefix
                         "File.c"
                         unity-temp-sensor-primatives-list)))
  )                                           
(ert-deftest unity-strip-primative-suffix-test ()
  (should (equal "_spec" (unity-strip-primative-suffix
                         "File_spec.c"
                         unity-temp-sensor-primatives-list)))
  (should (equal "" (unity-strip-primative-suffix
                         "File.c"
                         unity-temp-sensor-primatives-list)))
  )
...
(ert-deftest unity-find-primative-test ()
  (should (equal 0
                 (unity-find-primative
                  "TestFile.c" unity-temp-sensor-primatives-list)))
  (should (equal 1
                 (unity-find-primative
                  "File_spec.rb" unity-temp-sensor-primatives-list)))
  (should-not (equal 0
                 (unity-find-primative
                  "TestFile.h" unity-temp-sensor-primatives-list)))
  (should (equal 2
                 (unity-find-primative
                  "file.C" unity-temp-sensor-primatives-list)))
  (should (equal 3
                 (unity-find-primative
                  "file.asm" unity-temp-sensor-primatives-list)))
  (should (equal 4
                 (unity-find-primative
                  "file.h" unity-temp-sensor-primatives-list)))
  (should (equal 5
                 (unity-find-primative
                  "file.org" unity-temp-sensor-primatives-list)))
  (should (equal 6
                 (unity-find-primative
                  "file.yml" unity-temp-sensor-primatives-list)))
  (should-not (unity-find-primative
               "Testfile.yml" unity-temp-sensor-primatives-list))
  (should-not (unity-find-primative
               "Testfile.h" unity-temp-sensor-primatives-list))
  (should-not (unity-find-primative
               "Testfile-tests.c" unity-temp-sensor-primatives-list))
  )

(ert-deftest  unity-find-a-primative-match-test ()
  (should
   (equal
    (concat unity-project-root-dir "src/AdcConductor.c")
                 (unity-find-a-primative-match "AdcConductor"
                                               0
                                               unity-temp-sensor-primatives-list
                                               'forward)))
  (should
   (equal
    (concat unity-project-root-dir "src/AdcConductor.h")
                 (unity-find-a-primative-match "AdcConductor"
                                               2
                                               unity-temp-sensor-primatives-list
                                               'forward)))
  ...
  (should
   (equal
    (concat unity-project-root-dir "test/TestAdcConductor.c")
                 (unity-find-a-primative-match "AdcConductor"
                                               4
                                               unity-temp-sensor-primatives-list
                                               'forward)))
...
(ert-deftest unity-find-and-open-a-primative-match-forward-test ()
  (should (equal (concat unity-project-root-dir "src/AdcConductor.h")
                 (unity-find-and-open-a-primative-match
                  'forward "AdcConductor.c")))
  (should (equal (concat unity-project-root-dir "test/TestAdcConductor.c")
                 (unity-find-and-open-a-primative-match
                  'forward "AdcConductor.h")))
  (should (equal (concat unity-project-root-dir "src/AdcConductor.c")
                 (unity-find-and-open-a-primative-match
...
(ert-deftest unity-find-and-open-a-primative-match-reverse-test ()
  (should (equal (concat unity-project-root-dir "test/TestAdcConductor.c")
                 (unity-find-and-open-a-primative-match
                  'reverse "AdcConductor.c")))
  (should (equal (concat unity-project-root-dir "src/AdcConductor.c")
                 (unity-find-and-open-a-primative-match
                  'reverse "AdcConductor.h")))
  (should (equal (concat unity-project-root-dir "src/AdcConductor.h")
                 (unity-find-and-open-a-primative-match
                  'reverse "TestAdcConductor.c")))
  ) 
